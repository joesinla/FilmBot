...
Ext.define('MyApp.controller.Inventory', {
    ...
    onAddInventoryButtonTap: function(button, e, options) {
    ...
    onCloseInventoryButtonTap: function(button, e, options) {
    ...
    onInventoryEnterButtonTap: function(button, e, options) {
