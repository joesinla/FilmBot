        ...
        get: function(options,callback,scope) {
            if(Ext.cf.util.ParamValidator.validateOptionsCallbackScope([
               { name: "name", type: 'string' }
                 ...
                 callback.call(scope, this.createObject(options));
            }
        },
...
Ext.define('Ext.io.ux.Strings', {
    
    statics: {
        
        CHANGE_PASSWORD_MASK:  'Updating Password...', 
        CHANGE_PASSWORD_SUCCESS: 'Password Updated',
        
        MSGBOX_PASSWORD_TITLE: "Password",
...
Ext.define("Ext.io.ux.AuthSencha", {
    ...
    */
    hideLogin: function(){
        Ext.io.User.getCurrent(function(user,err){
        
            if(user){this.fireEvent('cancel');}
        });
   ...
   /**
    ...
    /**
      ...
      */
        ...
        */
        initialize: function() {
            var fbConf = this.config.group.getData().auth.fb;
